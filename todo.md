...
- [x] Identify architecturally significant requirements
- [x] Define and describe main subsystems of the project
...
- [x] Create Architecture Decision Records (ADRs) for major design decisions:
  - [x] ADR 1: Frontend framework selection
  - [x] ADR 2: Backend architecture
  - [x] ADR 3: Database technology
...
- [ ] Quantify at least 2 non-functional requirements
